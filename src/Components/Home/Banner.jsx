        ...
        <>
          <section className='flex justify-between items-center'>
            <div>
                ...
                <a href="https://github.com/sabkat-ahmed-rafi" target='_blank' className='btn bg-[#001C55] text-white hover:text-[#001C55] hover:bg-transparent hover:border hover:border-[#001C55] '><button className='flex space-x-2 items-center'><FaStar  color='yellow' size={20} className='hover:text-[#001C55]' /><span className='text-xl '> Star Me On Github</span></button></a>
                </div>
            </div>
            <div>
