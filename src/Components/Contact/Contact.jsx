    ...
    return (
        <>
           <section className='flex lg:flex-row flex-row-reverse lg:justify-center  justify-between'>
            ...
            <div key={location.pathname} className='lg:pl-0 pl-4  lg:text-center lg:space-y-4 space-y-2 w-[530px] lg:pt-[150px] pt-5 animate__animated animate__zoomIn'>
                <h1 className='lg:text-5xl text-2xl font-semibold font-roboto text-[#001C55]'>Contact Me</h1>
                <p className='font-[400] text-slate-500 font-roboto lg:text-xl'>I am available on almost every social media. You can message me, I will reply within 24 hours. I can help you with React, Javascript and Mern stack Development. </p>
